module.exports = {
    up: async (queryInterface, Sequelize) => {
      ...
      return queryInterface.bulkInsert('Solicitantes', [
        { idGenero: 1, idUsuario: 1, nombresSolic: 'Antonio Alejandro', apellidosSolic: 'Banderas Trujillo', fechaNacimiento: '1999-05-12 18:00:00.000 -0600', dui: '010101201', pasaporte: '12345221323', nit: '0202-0452-2323', nup: '212312323213213', direcSolic: 'San Salvador, El Salvador', telefonoSolic: '75747392', facebook: 'solicitante1', twitter: 'solic12316', linkedin: 'user1232', createdAt: new Date(), updatedAt: new Date() },
      ], {});
    },
