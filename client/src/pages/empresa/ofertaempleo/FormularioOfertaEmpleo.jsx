...
export const FormularioOfertaEmpleo = ({
  createData,
  updateData,
  dataToEdit,
  setDataToEdit,
  ...
  return (
    <FormContainer>
      <FormTitle>{dataToEdit ? "Editar oferta de empleo" : "Agregar oferta de empleo"}</FormTitle>
      <Formulario onSubmit={handleSubmit}>
       {/*Titulo oferta*/} 
        ...
        <FormInputBotton type="submit" value="Guardar" />
