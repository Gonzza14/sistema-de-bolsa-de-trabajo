module.exports = {
    up: async (queryInterface, Sequelize) => {
      ...
      return queryInterface.bulkInsert('Logros', [
        { idCurriculum: 1, logroRealizado:'Ingles Avanzado', fechaLogro: '10/10/2019', createdAt: new Date(), updatedAt: new Date() },
      ], {});
    },
  
    down: (queryInterface, Sequelize) => {
      // Aquí puedes definir cómo deshacer la inserción utilizando el método 'bulkDelete' de 'queryInterface'
      return queryInterface.bulkDelete('Logros', null, {});
    }
};