module.exports = {
    up: async (queryInterface, Sequelize) => {
      ...
      return queryInterface.bulkInsert('Solicitantes', [
        { idGenero: 1, idUsuario: 1, nombresSolic: 'Antonio Alejandro', apellidosSolic: 'Banderas Trujillo', fechaNacimiento: '13/05/1999', dui: '0101012001-1', pasaporte: '12345221323', nit: '0202-0452-232323', nup: '212312323213213', direcSolic: 'San Salvador, El Salvador', telefonoSolic: '75747392', facebook: 'solicitante1', twitter: 'solic12316', linkedin: 'user1232', createdAt: new Date(), updatedAt: new Date() },
      ], {});
    },
