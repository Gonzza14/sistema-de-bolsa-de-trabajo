...
import { DataTableStyleCV,  paginationComponentOptions } from "../../../styles/elements/tabla";
...
export const TablaConAcademico = ({ data, setDataToEdit, deleteData, setResponse }) => {
    ...
    const columns = [
        {
            ...
            selector: row => row.nomInstitucion,
            sortable: true,
        },
        {
            name: 'Nombre Curso',
        ...
        },
        {
            ...
            selector: row => row.periodoConAcad,
        },
        {
            name: 'Accion',
            key: "action",
